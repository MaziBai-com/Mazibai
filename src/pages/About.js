...
<>
<div class= "headers">
    <li style={{color:'#fff',position:"fixed",left:'30px',top:'30px',zIndex:'1000'}}><Link style={{color:'white'}} to="/"> <i style={{marginRight:'5px'}} className='fas fa-arrow-left'></i>Back to Home</Link></li>
  <nav class="circle">
  </nav>
...
<div class="about_us" style={{width:'100vw',marginRight:'auto',marginLeft:'auto'}}>
  ...
  <div class="missionn">
    <span>MISSION</span>
    <p>Our mission is to give best services at affordable rates. </p>
  </div>
  <span>ABOUT US</span>
  ...
  <p style={{color:'#fff'}}>
    Thank you for considering MaziBai to provide Home services and  All your needs. Our vision and commitment to our customers is to deliver quality service and personal attention.
  </p>
</div>
<Footer/>
